...
| **Governance**        | 13 ADRs in `decisions/`; 18 pi-native skills in `skills/`                       |
...
├── skills/                   # 18 pi-native skills (git-commit-message, review-loop, session-close, shell-safety, skill-auditor, skill-creator, git-worktree, decisions, pi-web-search, research-prompt, main-vault-query, risky-changes, diagnose-crash, omarchy, omarchy-migration, model-audit, local-ocr, diagram-render)
