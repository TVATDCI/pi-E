...
| **Governance**        | 13 ADRs in `decisions/`; 19 pi-native skills in `skills/` (+ `omarchy` + `diagnose-crash` OS-owned via `~/.agents/skills` symlinks — Omarchy package, single-sourced `984b953`) |
